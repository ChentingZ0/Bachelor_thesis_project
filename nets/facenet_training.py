...
# keras.backend is a powerful tool for building complex neural networks and implementing custom layers and loss functions in Keras.
# 分三份， batch_size为一份的量

def triplet_loss(alpha = 0.2, batch_size = 32):     # alpha -> margin, hyper parameter
