...
from Face_recognition import predict_image_for_server_2, Handler, predict_image_realtime
from PIL import Image, ImageOps
from utils.utils import allowed_file, remove_file_extension, save_image

# make a web application using FLASK
# import numpy
# numpy.load()
...
# 设置相关的路径
# uploads_path = r"C:\Users\RTX3080\Downloads\face_recogniton_websites-master\face_recogniton_websites-master\img"
uploads_path = "./img"
...
model = Facenet()
# model.detect_image(image_1=Image.open(r"C:\Users\RTX3080\Downloads\face_recogniton_websites-master\face_recogniton_websites-master\test_1.jpg"), image_2=Image.open(r"C:\Users\RTX3080\Downloads\face_recogniton_websites-master\face_recogniton_websites-master\test_2.jpg"))
model.detect_image(image_1=Image.open("./test_samples/taylor.png"), image_2=Image.open("./test_samples/taylor1_KN95.png"))
handler = Handler()
    ...
    while True:
        ...
        if bboxes.shape[0] == 0:
            ...
            for i in range(bboxes.shape[0]):
                ...
                res = predict_image_realtime(model=model, path_name="./loss", image1=image)
